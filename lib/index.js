            ...
            switch (valueProcRule) {
                case "TOSTR":
                    if (srcPropValueObj.asstring === "") {
                        ...
                        srcPropValueObj.asnumber = exports.invalidNumber;
                    }
                    break;
                case "TONUM":
                    if ((srcPropValueObj.asnumber === exports.invalidNumber) && (srcPropValueObj.asstring !== "")) {
                        const valnumber = Number.parseInt(srcPropValueObj.asstring, 10);
